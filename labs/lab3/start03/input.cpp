...
const char* cstring( inputtype inp )
{
   ...
   case inp_scanerror:     return "scanerror"; 
...
namespace
{
   ...
   buildclassifier( )
   {
      ...
      classifier< char, inputtype > cls( inp_scanerror );
      ...
      cls. insert( idfirst * idnext. star( ), inp_ident );
...
read( lexing::filereader& inp )
{
   ...
   if( p. second > 0 )
      ...
      return std::pair( inp_scanerror, 1 ); 
}
